...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(wombat spacemacs-dark)
...
you should place your code here."
  ...
  ;; visual doesn't override system clipboard
  ...
  ;; (define-key evil-mc-key-map (kbd "g r P") 'evil-mc-skip-and-goto-prev-match)
  ;; (define-key evil-mc-key-map (kbd "g r N") 'evil-mc-skip-and-goto-next-match)
  ;; (define-key evil-mc-key-map (kbd "g r p") 'evil-mc-make-and-goto-prev-match)
  ;; (define-key evil-mc-key-map (kbd "g r n") 'evil-mc-make-and-goto-next-match)
